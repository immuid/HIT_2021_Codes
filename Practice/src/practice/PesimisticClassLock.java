...
public class PesimisticClassLock {
...
class InterviewHall{
	public static void interviewer1() {
		System.out.println("first Interviewer asked question .....to...:"+Thread.currentThread().getName());
	}
	
	public static void interviewer2() {
		System.out.println("second Interviewer asked question....to...:"+Thread.currentThread().getName());
	}
	public static void interviewer3() {
		System.out.println("third Interviewer asked question....to...:"+Thread.currentThread().getName());
	}
}
